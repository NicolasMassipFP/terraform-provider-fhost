---
page_title: "iuis_ignore"
subcategory: ""
description: |-
  This represents an entry in the Integrated User ID service's ignore list, which can specify a username, IP address, or network element to ignore.
---
