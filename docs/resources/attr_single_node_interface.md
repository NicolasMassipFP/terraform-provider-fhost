---
page_title: "single_node_interface"
subcategory: "interfaces"
description: |-
  This represents a Node Dedicated Interface for Single Firewall, which is a unique IP address for each machine.
---

# single_node_interface (Nested-Attribute)

This represents a Node Dedicated Interface for Single Firewall, which is a unique IP address for each machine.

## Examples

- see [here](https://github.com/Forcepoint/terraform-provider-fp-ngfw-smc/blob/release/0.0.1/examples/engines/single_fw/single_fw_dynamic_interfaces) for a full example
