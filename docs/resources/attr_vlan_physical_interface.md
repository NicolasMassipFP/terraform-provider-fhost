---
page_title: "vlan_interface"
subcategory: "interfaces"
description: |-
  This represents a VLAN Interface for a Virtual Engine. VLANs divide a single physical network link into several virtual links, with a maximum of 4094 VLANs per physical interface. The VLANs must also be defined in the configuration of the switch or router to which the interface is connected.
---

# vlan_interface (Nested-Attribute)

This represents a VLAN Interface for a Virtual Engine. VLANs divide a single physical network link into several virtual links, with a maximum of 4094 VLANs per physical interface. The VLANs must also be defined in the configuration of the switch or router to which the interface is connected.

## Examples

- see [here](https://github.com/Forcepoint/terraform-provider-fp-ngfw-smc/blob/release/0.0.1/examples/engines/single_fw/single_fw_vlan_interfaces) for a full example
