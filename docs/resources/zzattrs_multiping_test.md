...
- `enabled_interface` (List of Blocks, see [here](zzattrs_enabled_interface_entry.md)) The source interfaces for the Multiping test. If not specified, the source IP address is selected automatically based on standard routing rules.
