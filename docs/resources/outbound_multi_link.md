...
- `multilink_member` (List of Blocks, see [here](../attributes/multilink_member.md)) The members of the Outbound Multi-Link, which are NetLinks that can be used for load balancing.
- `multilink_qos_class` (List of Blocks, see [here](../attributes/multi_link_qos_class_member.md)) The QoS class members of the Outbound Multi-Link, which define quality of service parameters for load balancing.
