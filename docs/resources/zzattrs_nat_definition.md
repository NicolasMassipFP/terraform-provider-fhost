...
- `enabled_interface` (List of Blocks, see [here](zzattrs_enabled_interface_entry.md)) The interfaces that are enabled for NAT, which can be used to specify the public interfaces for the NAT definition.
