...
- see [here](https://github.com/Forcepoint/terraform-provider-fp-ngfw-smc/tree/main//examples/engines/single_fw/single_fw_modem_interfaces) for a full example
