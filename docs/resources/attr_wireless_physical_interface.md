---
page_title: "wireless_interface"
subcategory: "interfaces"
description: |-
  This represents a Wireless Physical Interface, which is used for connecting to wireless networks. It supports various wireless modes and configurations.
---

# wireless_interface (Nested-Attribute)

This represents a Wireless Physical Interface, which is used for connecting to wireless networks. It supports various wireless modes and configurations.

## Examples

- see [here](https://github.com/Forcepoint/terraform-provider-fp-ngfw-smc/blob/release/0.0.1/examples/engines/single_fw/single_fw_wireless_interface) for a full example
...
- `ssid_interfaces` (List of Blocks, see [here](attr_ssid_physical_interface.md)) The list of SSID interfaces associated with this wireless physical interface. Each SSID interface represents a unique wireless network configuration.
