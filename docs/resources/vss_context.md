...
page_title: "smc_vss_context Resource - smc"
subcategory: ""
description: |-
...
- `vc_isc` (Block, Optional) This represents the ISC settings for a VSS Context, including the traffic tag, policy ID, and ISC name. (see [below for nested schema](#nestedblock--vc_isc))
...
<a id="nestedblock--vc_isc"></a>
### Nested Schema for `vc_isc`
