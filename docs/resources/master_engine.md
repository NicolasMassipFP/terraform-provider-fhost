...
page_title: "smc_master_engine Resource - smc"
subcategory: ""
description: |-
...
- `virtual_resources` (Block List) (see [below for nested schema](#nestedblock--virtual_resources))
...
<a id="nestedblock--virtual_resources"></a>
### Nested Schema for `virtual_resources`

Optional:

- `virtual_resource` (Block, Optional) This represents a set of resources on the Master NGFW Engine that are allocated to each Virtual NGFW Engine. It includes properties such as ID, domain allocation, and resource limits. (see [below for nested schema](#nestedblock--virtual_resources--virtual_resource))

<a id="nestedblock--virtual_resources--virtual_resource"></a>
### Nested Schema for `virtual_resources.virtual_resource`
...
- `key` (Number) The unique identifier for the element. This field is required for updates but not for creation.
- `link` (Attributes List) The API's links of the element, providing additional actions or resources. (see [below for nested schema](#nestedatt--virtual_resources--virtual_resource--link))
- `lk` (Map of String)

<a id="nestedatt--virtual_resources--virtual_resource--link"></a>
### Nested Schema for `virtual_resources.virtual_resource.link`
