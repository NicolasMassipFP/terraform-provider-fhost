...
- `port_group_interface` (List of Blocks, see [here](../attributes/port_group_interface.md)) A list of Port Group Interfaces defined under this Switch Interface. Each Port Group Interface is represented by a PortGroupInterfaceDTO.
