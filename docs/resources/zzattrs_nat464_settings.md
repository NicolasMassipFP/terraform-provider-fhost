...
- `nat64_mapping` (List of Blocks, see [here](zzattrs_nat64_mapping.md)) The static mappings for NAT64 mode, which is not required.
- `siit_eam_mapping` (List of Blocks, see [here](zzattrs_siit_mapping.md)) The mappings for SIIT EAM mode, which is not required.
