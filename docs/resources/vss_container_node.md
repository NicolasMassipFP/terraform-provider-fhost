...
page_title: "smc_vss_container_node Resource - smc"
subcategory: ""
description: |-
...
# smc_vss_container_node (Resource)
...
- `vss_node_isc` (Block, Optional) This represents the ISC Firewall Node Settings container, which includes management IP, gateway, hypervisor, and network settings. (see [below for nested schema](#nestedblock--vss_node_isc))
...
<a id="nestedblock--vss_node_isc"></a>
### Nested Schema for `vss_node_isc`
