...
- `ospf_abr_substitute_container` (List of Blocks, see [here](zzattrs_ospf_abr_substitute_container.md)) The ABR substitute networks for this OSPF area. These are used to substitute routes in ABR areas.
- `ospfv2_virtual_links_endpoints_container` (List of Blocks, see [here](zzattrs_ospfv2_virtual_links_end_points_container.md)) The OSPFv2 Virtual Links Endpoints Container belonging to the OSPFv2 Area.
