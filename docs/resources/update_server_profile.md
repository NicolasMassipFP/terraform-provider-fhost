...
- `ordered_url` (List of Blocks, see [here](../attributes/ranked_url.md)) The list of URLs to connect to the update server. At least one URL is mandatory.
- `TLSIdentity` (Single Block, see [here](../attributes/tls_identity.md)) 
