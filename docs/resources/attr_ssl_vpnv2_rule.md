---
page_title: "sslvpn_rule"
subcategory: "sslvpn"
description: |-
  This represents an Application Access Rule. It is used to define rules for Application Access Portal, including web services and user authentication.
---

# sslvpn_rule (Nested-Attribute)
...
- `ssl_vpn_web_service` (List of String) URI of the Application Access web service.
...
## Nested Attributes
- `authentication` (Single Block, see [here](attr_user_authentication_match.md)) 
