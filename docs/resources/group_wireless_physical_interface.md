...
- `ssidInterfaces` (List of Blocks, see [here](../attributes/ssid_physical_interface.md)) The list of SSID interfaces associated with this wireless physical interface. Each SSID interface represents a unique wireless network configuration.
