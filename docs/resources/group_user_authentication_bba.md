...
- `enabled_interface` (List of Blocks, see [here](../attributes/enabled_interface_entry.md)) The list of interfaces on which the service listens. Each entry represents an enabled interface.
