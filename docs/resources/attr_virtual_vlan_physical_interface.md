---
page_title: "virtual_vlan_interface"
subcategory: "interfaces"
description: |-
  This represents a Virtual VLAN Physical Interface, which is used for creating VLANs on Virtual NGFW Engines. It allows the division of a single physical network link into multiple virtual links, with a maximum of 4094 VLANs per physical interface.
---

# virtual_vlan_interface (Nested-Attribute)
