...
- `enabled_interface` (List of Blocks, see [here](zzattrs_enabled_interface_entry.md)) The list of interfaces on which the service listens. Each entry represents an enabled interface.
