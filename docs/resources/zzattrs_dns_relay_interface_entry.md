---
page_title: "dns_relay_interface"
subcategory: ""
description: |-
  This represents the listening interface for DNS Relay, which is used to define the DNS Relay interface settings in the engine configuration.
---
