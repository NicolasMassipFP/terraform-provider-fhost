...
- see [here](https://github.com/Forcepoint/terraform-provider-fp-ngfw-smc/blob/release/0.0.1/examples/engines/fw_cluster/fw_cluster_with_layer2_interface) for a complete example
