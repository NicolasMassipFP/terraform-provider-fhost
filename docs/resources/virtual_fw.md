...
page_title: "smc_virtual_fw Resource - smc"
subcategory: ""
description: |-
...
- `certificate_validation_settings` (Block, Optional) This defines common settings for certificate validation on the engine, including CRL distribution points. (see [below for nested schema](#nestedblock--certificate_validation_settings))
