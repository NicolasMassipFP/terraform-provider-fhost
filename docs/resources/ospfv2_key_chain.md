...
- `ospfv2_key_chain_entry` (List of Blocks, see [here](zzattrs_ospf_key_chain_entry.md)) The OSPFv2 Key Chain Entries, which define the keys used for authentication in the OSPFv2 Key Chain.
