...
- `interface_setting` (List of Blocks, see [here](zzattrs_traffic_capture_interface_settings.md)) The interface setting for capturing traffic on a specific network interface. This defines how traffic should be captured on a particular interface.
