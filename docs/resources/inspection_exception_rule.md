...
- `max_severity` (Number) The maximum severity value for the rule. This is used to filter situations based on their severity level.
- `min_severity` (Number) The minimum severity value for the rule. This is used to filter situations based on their severity level.
...
- `protocols` (Single Block, see [here](../attributes/protocol_match_part.md)) 
- `situations` (Single Block, see [here](../attributes/situation_match_part.md)) 
