...
page_title: "smc_inspection_exception_rule Resource - smc"
subcategory: ""
description: |-
...
# smc_inspection_exception_rule (Resource)
...
- `protocols` (Block, Optional) This represents the Inspection Protocol matching criteria for an IPS Policy Rule, which can specify whether any or none of the protocols match, or list specific elements that match. (see [below for nested schema](#nestedblock--protocols))
