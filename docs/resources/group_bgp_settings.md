...
- `announced_ne_setting` (List of Blocks, see [here](../attributes/bgp_announced_network_association.md)) The BGP Announced Network Element settings, which can include multiple associations.
