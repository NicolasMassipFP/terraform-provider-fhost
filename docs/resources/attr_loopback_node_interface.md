---
page_title: "loopback_node_dedicated_interface"
subcategory: "interfaces"
description: |-
  This represents the Loopback Node Interface, which is used for loopback traffic sent to a specific node in the cluster. NDI loopback IP addresses must be unique for each node.
---

# loopback_node_dedicated_interface (Nested-Attribute)
