---
page_title: "smc_tcp_service"
subcategory: "services"
description: |-
  This represents a TCP service, which is used to define a service based on the Transmission Control Protocol (TCP). It includes a port number for traffic identification.
---

# smc_tcp_service (Resource)
