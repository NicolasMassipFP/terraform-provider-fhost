---
page_title: "bsr_candidate_interface"
subcategory: ""
description: |-
  This represents the BSR Candidate listening interface, which is used to define the BSR Candidate interface settings in the engine configuration.
---
