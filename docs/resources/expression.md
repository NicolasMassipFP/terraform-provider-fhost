...
- `sub_expression` (List of Blocks, see [here](../attributes/expression.md)) A list of inner expressions that are part of the overall expression. These expressions can be combined using the specified operator.
