...
- `qos_role` (List of Blocks, see [here](../attributes/qos_class_with_role.md)) A list of QoS classes with roles associated with this NetLink, defining how traffic is prioritized and managed.
