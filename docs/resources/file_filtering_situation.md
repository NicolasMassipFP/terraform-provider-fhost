---
page_title: "smc_file_type"
subcategory: "situations"
description: |-
  This represents a File Filtering Situation, which is used for filtering files based on their type.
---

# smc_file_type (Resource)


⚠️ __Experimental feature, use with caution__. This feature is not yet fully supported and may change without deprecation in future releases.This represents a File Filtering Situation, which is used for filtering files based on their type.
