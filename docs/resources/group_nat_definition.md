...
- `enabled_interface` (List of Blocks, see [here](../attributes/enabled_interface_entry.md)) The interfaces that are enabled for NAT, which can be used to specify the public interfaces for the NAT definition.
