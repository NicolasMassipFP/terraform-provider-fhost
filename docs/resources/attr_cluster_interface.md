---
page_title: "cluster_virtual_interface"
subcategory: "interfaces"
description: |-
  This represents the definition of a Cluster Virtual Interface (CVI), which is an IP and MAC address shared by all nodes in a cluster, used for communication and reducing network complexity.
---

# cluster_virtual_interface (Nested-Attribute)
