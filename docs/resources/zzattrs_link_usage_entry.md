...
- `link_usage_preference` (List of Blocks, see [here](zzattrs_link_usage_preference.md)) The link usage preferences associated with this entry, which can include preferences for using or avoiding certain links.
