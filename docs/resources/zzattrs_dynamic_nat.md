...
- `translation_values` (List of Blocks, see [here](zzattrs_translation_value.md)) A list of translation values that define how source addresses are translated in dynamic NAT.
