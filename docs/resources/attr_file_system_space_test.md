---
page_title: "filesystemspace_test"
subcategory: ""
description: |-
  This represents a test that monitors the free disk space on a hard disk partition. It is not suitable for appliances that use a flash card instead of a hard disk.
---

# filesystemspace_test (Nested-Attribute)
