...
- `inspected_service` (List of Blocks, see [here](../attributes/inspected_service.md)) The list of Inspected Services that define how the Proxy Server inspects traffic. Each service can have its own settings and requirements.
