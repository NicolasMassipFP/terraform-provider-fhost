...
page_title: "smc_integrated_uis Resource - smc"
subcategory: ""
description: |-
...
- `iuis_ignore` (Block List) (see [below for nested schema](#nestedblock--iuis_ignore))
...
<a id="nestedblock--iuis_ignore"></a>
### Nested Schema for `iuis_ignore`
