...
subcategory: ""
description: |-
  This represents the Firewall Rule Options, which are used in Firewall Access/NAT Rules for source/destination static/dynamic NAT settings and logging settings.
---
...
- `dynamic_dst_nat` (Single Block, see [here](../attributes/dynamic_nat.md)) 
- `dynamic_src_nat` (Single Block, see [here](../attributes/dynamic_nat.md)) 
- `proxy_dst_nat` (Single Block, see [here](../attributes/proxy_nat.md)) 
- `static_dst_nat` (Single Block, see [here](../attributes/static_nat.md)) 
- `static_src_nat` (Single Block, see [here](../attributes/static_nat.md)) 
