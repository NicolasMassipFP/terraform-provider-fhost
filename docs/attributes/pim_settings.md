...
- `bsr_candidate_interface` (Single Block, see [here](../attributes/bsr_candidate_interface_entry.md)) 
- `rp_candidate_interface` (Single Block, see [here](../attributes/rp_candidate_interface_entry.md)) 
- `sm_rp_candidate_entry` (List of Blocks, see [here](../attributes/pim_sm_bootstrap_settings_rp_candidate_entry.md)) The PIM-SM RP Candidate entries for multicast groups.
