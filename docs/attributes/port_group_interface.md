...
- `switch_interface_port` (List of Blocks, see [here](../attributes/switch_interface_port.md)) A list of ports attached to this Port Group Interface. Each port is represented by a SwitchInterfacePortDTO.
