...
- `antispoofing_node` (List of Blocks, see [here](../attributes/antispoofing_node.md)) A list of Antispoofing child nodes, which represent individual antispoofing configurations for interfaces.
