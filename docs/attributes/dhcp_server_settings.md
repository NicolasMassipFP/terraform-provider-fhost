...
- `dhcp_range_per_node` (List of Blocks, see [here](../attributes/dhcp_range_node.md)) The DHCP Range Nodes which contain a DHCP Address Range for each node in a cluster.
