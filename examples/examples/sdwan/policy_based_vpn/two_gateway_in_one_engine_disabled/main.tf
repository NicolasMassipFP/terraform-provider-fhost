...
data "smc_href" "internal_gateway_1_ref" {
  name = "${smc_single_fw.tf_single_fw1.lk.internal_gateway}#tf_single_fw1*"
}

data "smc_href" "internal_gateway_2_ref" {
  name = "${smc_single_fw.tf_single_fw2.lk.internal_gateway}#tf_single_fw2*"
}
...
resource "smc_gateway_node" "tf_sample_gateway_1_node" {
  ...
  node_usage = "central"
  gateway    = data.smc_href.internal_gateway_1_ref.id
}
...
resource "smc_gateway_node" "tf_sample_gateway_2_node" {
  ...
  node_usage = "central"
  gateway    = data.smc_href.internal_gateway_2_ref.id
}
...
#   id      = "${smc_vpn.tf_sample_vpn.lk.gateway_tunnel}#Gateway Tunnel*"
