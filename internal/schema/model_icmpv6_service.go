...
type Icmpv6ServiceResourceModel struct {
	...
	IcmpCode         types.Int64                                        `tfsdk:"icmp_code" json:"icmp_code,optional,omitempty" `
	IcmpType         types.Int64                                        `tfsdk:"icmp_type" json:"icmp_type,optional,omitempty" `
...
func (r *Icmpv6ServiceResourceModel) GetSliceIds(ctx context.Context) []string {
