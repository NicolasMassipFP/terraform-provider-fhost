...
type WebSiteAccessSituationParameterValueResourceModel struct {
	ID                types.String                                       `tfsdk:"id"`
	FromRef           types.String                                       `tfsdk:"from_ref"`
	Comment           types.String                                       `tfsdk:"comment" json:"comment,optional,omitempty" `
	Dfas              *[]types.String                                    `tfsdk:"dfas" json:"dfas,optional,omitempty" `
	...
	RegularExpression types.String                                       `tfsdk:"reg_exp" json:"reg_exp,optional,omitempty" `
}

func (r *WebSiteAccessSituationParameterValueResourceModel) GetSliceIds(ctx context.Context) []string {
