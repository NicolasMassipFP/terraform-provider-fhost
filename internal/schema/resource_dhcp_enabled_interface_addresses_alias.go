...
// This file was automatically generated from OpenAPI schema: DHCP_Enabled_Interface_Addresses_Alias
...
type DhcpEnabledInterfaceAddressesAliasResource struct {
	smcresource.ResourceBase[DhcpEnabledInterfaceAddressesAliasResourceModel]
}
...
// NewDhcpEnabledInterfaceAddressesAliasResource creates a new instance of the DhcpEnabledInterfaceAddressesAlias resource.
func NewDhcpEnabledInterfaceAddressesAliasResource() resource.Resource {
	...
	r := &DhcpEnabledInterfaceAddressesAliasResource{
		ResourceBase: smcresource.ResourceBase[DhcpEnabledInterfaceAddressesAliasResourceModel]{
