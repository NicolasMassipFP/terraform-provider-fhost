...
type UserIdServiceResourceModel struct {
	...
	CacheExpiration      types.Int64                                        `tfsdk:"cache_expiration" json:"cache_expiration,optional,omitempty" `
	Comment              types.String                                       `tfsdk:"comment" json:"comment,optional,omitempty" `
	ConnectTimeout       types.Int64                                        `tfsdk:"connect_timeout" json:"connect_timeout,optional,omitempty" `
	...
	List                 *[]types.String                                    `tfsdk:"list" json:"list,optional,omitempty" `
	...
	MonitoredUserDomains *[]types.String                                    `tfsdk:"monitored_user_domains" json:"monitored_user_domains,optional,omitempty" `
	...
	TlsIdentity          *TlsIdentityResourceModel                          `tfsdk:"tls_identity" json:"tls_identity,optional,omitempty" `
...
func (r *UserIdServiceResourceModel) GetSliceIds(ctx context.Context) []string {
