...
type FloatSituationParameterValueResourceModel struct {
	...
	Value        types.Float64                                      `tfsdk:"value" json:"value,optional,omitempty" `
}

func (r *FloatSituationParameterValueResourceModel) GetSliceIds(ctx context.Context) []string {
