...
type RpcServiceResourceModel struct {
	...
	RpcVersion       types.String                                       `tfsdk:"rpc_version" json:"rpc_version,optional,omitempty" `
	...
	Transport        types.String                                       `tfsdk:"transport" json:"transport,optional,omitempty" `
	Trashed          types.Bool                                         `tfsdk:"trashed" json:"trashed,optional,omitempty" fpro:"trashed"`
}

func (r *RpcServiceResourceModel) GetSliceIds(ctx context.Context) []string {
