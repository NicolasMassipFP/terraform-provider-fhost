...
type UrlListApplicationSituationResourceModel struct {
	...
	UrlEntry                 *[]types.String                                    `tfsdk:"url_entry" json:"url_entry,optional,omitempty" `
...
func (r *UrlListApplicationSituationResourceModel) GetSliceIds(ctx context.Context) []string {
