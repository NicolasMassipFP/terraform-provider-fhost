...
type SidewinderLoggingProfileResourceModel struct {
	...
	SidewinderLoggingProfileSetting *[]SidewinderLoggingProfileSettingsResourceModel   `tfsdk:"sidewinder_logging_profile_setting" json:"sidewinder_logging_profile_setting,optional,omitempty" `
...
func (r *SidewinderLoggingProfileResourceModel) GetSliceIds(ctx context.Context) []string {
