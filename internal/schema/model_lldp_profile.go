...
type LldpProfileResourceModel struct {
	...
	HoldTimeMultiplier types.Int64                                        `tfsdk:"hold_time_multiplier" json:"hold_time_multiplier,optional,omitempty" `
...
func (r *LldpProfileResourceModel) GetSliceIds(ctx context.Context) []string {
