...
type VpnTrafficSelectorResourceModel struct {
	...
	PortNumber     types.String                                       `tfsdk:"port_number" json:"port_number,optional,omitempty" `
	ProtocolNumber types.String                                       `tfsdk:"protocol_number" json:"protocol_number,optional,omitempty" `
...
func (r *VpnTrafficSelectorResourceModel) GetSliceIds(ctx context.Context) []string {
