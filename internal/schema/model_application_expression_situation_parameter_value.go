...
type ApplicationExpressionSituationParameterValueResourceModel struct {
	...
	Operator      types.String                                       `tfsdk:"operator" json:"operator,optional,omitempty" `
	...
	SubSituations *[]types.String                                    `tfsdk:"sub_situations" json:"sub_situations,optional,omitempty" `
}

func (r *ApplicationExpressionSituationParameterValueResourceModel) GetSliceIds(ctx context.Context) []string {
