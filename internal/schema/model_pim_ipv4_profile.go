...
type PimIpv4ProfileResourceModel struct {
	...
	JoinedPrune                types.Int64                                        `tfsdk:"joined_prune" json:"joined_prune,optional,omitempty" `
...
func (r *PimIpv4ProfileResourceModel) GetSliceIds(ctx context.Context) []string {
