...
type DomainNameResourceModel struct {
	...
	DomainNameEntry *[]types.String                                    `tfsdk:"domain_name_entry" json:"domain_name_entry,optional,omitempty" `
...
func (r *DomainNameResourceModel) GetSliceIds(ctx context.Context) []string {
