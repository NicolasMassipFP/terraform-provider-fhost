...
type L2InterfaceTemplatePolicyResourceModel struct {
	...
	FileFilteringPolicy types.String                                       `tfsdk:"file_filtering_policy" json:"file_filtering_policy,optional,omitempty" `
	InspectionPolicy    types.String                                       `tfsdk:"inspection_policy" json:"inspection_policy,optional,omitempty" `
	...
	Template            types.String                                       `tfsdk:"template" json:"template,optional,omitempty" `
	Trashed             types.Bool                                         `tfsdk:"trashed" json:"trashed,optional,omitempty" fpro:"trashed"`
}

func (r *L2InterfaceTemplatePolicyResourceModel) GetSliceIds(ctx context.Context) []string {
