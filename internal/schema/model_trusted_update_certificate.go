...
type TrustedUpdateCertificateResourceModel struct {
	ID          types.String                                       `tfsdk:"id"`
	Active      types.Bool                                         `tfsdk:"active" json:"active,optional,omitempty" `
	...
	Pem         types.String                                       `tfsdk:"pem" json:"pem,optional,omitempty" `
...
func (r *TrustedUpdateCertificateResourceModel) GetSliceIds(ctx context.Context) []string {
