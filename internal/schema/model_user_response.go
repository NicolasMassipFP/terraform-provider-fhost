...
type UserResponseResourceModel struct {
	...
	UserResponseEntry *[]UserResponseEntryResourceModel                  `tfsdk:"user_response_entry" json:"user_response_entry,optional,omitempty" `
}

func (r *UserResponseResourceModel) GetSliceIds(ctx context.Context) []string {
