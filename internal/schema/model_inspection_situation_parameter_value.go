...
type InspectionSituationParameterValueResourceModel struct {
...
func (r *InspectionSituationParameterValueResourceModel) GetSliceIds(ctx context.Context) []string {
