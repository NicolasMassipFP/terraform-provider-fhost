...
type UpdateServerProfileResourceModel struct {
	...
	OrderedUrl    *[]RankedUrlResourceModel                          `tfsdk:"ordered_url" json:"ordered_url,optional,omitempty" `
	ReadOnly      types.Bool                                         `tfsdk:"read_only" json:"read_only,optional,omitempty" fpro:"read_only"`
	Retry         types.Int64                                        `tfsdk:"retry" json:"retry,optional,omitempty" `
	...
	TLSIdentity   *TlsIdentityResourceModel                          `tfsdk:"tlsidentity" json:"TLSIdentity,optional,omitempty" `
	Trashed       types.Bool                                         `tfsdk:"trashed" json:"trashed,optional,omitempty" fpro:"trashed"`
}

func (r *UpdateServerProfileResourceModel) GetSliceIds(ctx context.Context) []string {
