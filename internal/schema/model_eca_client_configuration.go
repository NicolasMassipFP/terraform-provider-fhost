...
type EcaClientConfigurationResourceModel struct {
	ID            types.String                                       `tfsdk:"id"`
	AdminDomain   types.String                                       `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
	AutoDiscovery types.Bool                                         `tfsdk:"auto_discovery" json:"auto_discovery,optional,omitempty" `
	Comment       types.String                                       `tfsdk:"comment" json:"comment,optional,omitempty" `
	EcaCaRef      *[]types.String                                    `tfsdk:"eca_ca_ref" json:"eca_ca_ref,optional,omitempty" `
...
func (r *EcaClientConfigurationResourceModel) GetSliceIds(ctx context.Context) []string {
