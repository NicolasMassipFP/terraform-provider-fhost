...
type SshProfileResourceModel struct {
	...
	KeyExchanges types.String                                       `tfsdk:"key_exchanges" json:"key_exchanges,optional,omitempty" `
	...
	Macs         types.String                                       `tfsdk:"macs" json:"macs,optional,omitempty" `
...
func (r *SshProfileResourceModel) GetSliceIds(ctx context.Context) []string {
