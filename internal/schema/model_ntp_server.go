...
type NtpServerResourceModel struct {
	...
	NtpAuthKey           types.String                                       `tfsdk:"ntp_auth_key" json:"ntp_auth_key,optional,omitempty" `
	NtpAuthKeyId         types.Int64                                        `tfsdk:"ntp_auth_key_id" json:"ntp_auth_key_id,optional,omitempty" `
	NtpAuthKeyType       types.String                                       `tfsdk:"ntp_auth_key_type" json:"ntp_auth_key_type,optional,omitempty" `
	NtpHostName          types.String                                       `tfsdk:"ntp_host_name" json:"ntp_host_name,optional,omitempty" `
...
func (r *NtpServerResourceModel) GetSliceIds(ctx context.Context) []string {
