...
// This file was automatically generated from OpenAPI schema: Physical_Interface
...
type PhysicalInterfaceResourceModel struct {
	...
	CviMode                       types.String                                       `tfsdk:"cvi_mode" json:"cvi_mode,optional,omitempty" `
	...
	LldpMode                      types.String                                       `tfsdk:"lldp_mode" json:"lldp_mode,optional,omitempty" `
	...
	RouteRepliesBackIpv4Address   types.String                                       `tfsdk:"route_replies_back_ipv4_address" json:"route_replies_back_ipv4_address,optional,omitempty" `
	RouteRepliesBackIpv6Address   types.String                                       `tfsdk:"route_replies_back_ipv6_address" json:"route_replies_back_ipv6_address,optional,omitempty" `
	RouteRepliesBackMode          types.Bool                                         `tfsdk:"route_replies_back_mode" json:"route_replies_back_mode,optional,omitempty" `
	...
	SyncParameter                 *SyncParameterResourceModel                        `tfsdk:"sync_parameter" json:"sync_parameter,optional,omitempty" `
	VirtualEngineVlanOk           types.Bool                                         `tfsdk:"virtual_engine_vlan_ok" json:"virtual_engine_vlan_ok,optional,omitempty" `
	...
	VlanInterfaces                *[]VlanPhysicalInterfaceResourceModel              `tfsdk:"vlan_interfaces" json:"vlanInterfaces,optional,omitempty" `
	ZoneRef                       types.String                                       `tfsdk:"zone_ref" json:"zone_ref,optional,omitempty" `
}

func (r *PhysicalInterfaceResourceModel) GetSliceIds(ctx context.Context) []string {
