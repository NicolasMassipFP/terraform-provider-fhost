...
// This file was automatically generated from OpenAPI schema: External_Test
...
type ExternalTestResourceModel struct {
	AlertNotification types.Bool                                         `tfsdk:"alert_notification" json:"alert_notification,optional,omitempty" `
	CommandLine       types.String                                       `tfsdk:"command_line" json:"command_line,optional,omitempty" `
...
func (r *ExternalTestResourceModel) GetSliceIds(ctx context.Context) []string {
