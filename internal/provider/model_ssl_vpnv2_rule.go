...
// This file was automatically generated from OpenAPI schema: SSL_VPNv2_Rule
...
type SslVpnv2RuleResourceModel struct {
	
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        Authentication *UserAuthenticationMatchResourceModel `tfsdk:"authentication" json:"Authentication,optional,omitempty" `
        ...
        SslVpnWebService *[]types.String `tfsdk:"ssl_vpn_web_service" json:"ssl_vpn_web_service,optional,omitempty" `
...
func (r *SslVpnv2RuleResourceModel) GetSliceIds(ctx context.Context) []string {
