...
type FirewallAlertResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        Message types.String `tfsdk:"message" json:"message,optional,omitempty" `
...
func (r *FirewallAlertResourceModel) GetSliceIds(ctx context.Context) []string {
