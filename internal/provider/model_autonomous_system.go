...
type AutonomousSystemResourceModel struct {
	
	ID                    types.String `tfsdk:"id"`
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        AsNumber types.String `tfsdk:"as_number" json:"as_number,optional,omitempty" `
...
func (r *AutonomousSystemResourceModel) GetSliceIds(ctx context.Context) []string {
