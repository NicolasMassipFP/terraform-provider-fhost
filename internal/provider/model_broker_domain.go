...
type BrokerDomainResourceModel struct {
	...
	FileRef          types.String                                       `tfsdk:"file_ref" json:"file_ref,optional,omitempty" `
	...
	MacAddressPrefix types.String                                       `tfsdk:"mac_address_prefix" json:"mac_address_prefix,optional,omitempty" `
...
func (r *BrokerDomainResourceModel) GetSliceIds(ctx context.Context) []string {
