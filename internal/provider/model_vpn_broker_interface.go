...
type VpnBrokerInterfaceResourceModel struct {
	ID                            types.String                                       `tfsdk:"id"`
	FromRef                       types.String                                       `tfsdk:"from_ref"`
	AdjustAntispoofing            types.Bool                                         `tfsdk:"adjust_antispoofing" json:"adjust_antispoofing,optional,omitempty" `
	...
	MacAddressPostfix             types.String                                       `tfsdk:"mac_address_postfix" json:"mac_address_postfix,optional,omitempty" `
	...
	RetrieveRoutes                types.Bool                                         `tfsdk:"retrieve_routes" json:"retrieve_routes,optional,omitempty" `
	...
	VpnBrokerDomainRef            types.String                                       `tfsdk:"vpn_broker_domain_ref" json:"vpn_broker_domain_ref,optional,omitempty" `
	ZoneRef                       types.String                                       `tfsdk:"zone_ref" json:"zone_ref,optional,omitempty" `
}

func (r *VpnBrokerInterfaceResourceModel) GetSliceIds(ctx context.Context) []string {
