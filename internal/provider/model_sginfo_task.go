...
type SginfoTaskResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        DestinationPath types.String `tfsdk:"destination_path" json:"destination_path,optional,omitempty" `
        Etag types.String `tfsdk:"etag" json:"etag,optional,omitempty" fpro:"etag"`
        IncludeCoreFiles types.Bool `tfsdk:"include_core_files" json:"include_core_files,optional,omitempty" `
        IncludeSlapcatOutput types.Bool `tfsdk:"include_slapcat_output" json:"include_slapcat_output,optional,omitempty" `
        ...
        StoredOnServer types.Bool `tfsdk:"stored_on_server" json:"stored_on_server,optional,omitempty" `
...
func (r *SginfoTaskResourceModel) GetSliceIds(ctx context.Context) []string {
