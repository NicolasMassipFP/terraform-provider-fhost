...
type UrlListSituationParameterValueResourceModel struct {
	...
	Urls         *[]types.String                                    `tfsdk:"urls" json:"urls,optional,omitempty" `
}

func (r *UrlListSituationParameterValueResourceModel) GetSliceIds(ctx context.Context) []string {
