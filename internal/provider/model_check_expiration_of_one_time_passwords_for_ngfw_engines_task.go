...
type CheckExpirationOfOneTimePasswordsForNgfwEnginesTaskResourceModel struct {
...
func (r *CheckExpirationOfOneTimePasswordsForNgfwEnginesTaskResourceModel) GetSliceIds(ctx context.Context) []string {
