...
type FileFilteringRuleResourceModel struct {
	ID                types.String                                       `tfsdk:"id"`
	FromRef           types.String                                       `tfsdk:"from_ref"`
	Action            *FileFilteringRuleActionResourceModel              `tfsdk:"action" json:"action,optional,omitempty" `
	...
	Options           *FileFilteringRuleOptionsResourceModel             `tfsdk:"options" json:"options,optional,omitempty" `
...
func (r *FileFilteringRuleResourceModel) GetSliceIds(ctx context.Context) []string {
