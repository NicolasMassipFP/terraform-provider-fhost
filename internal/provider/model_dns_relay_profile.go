...
type DnsRelayProfileResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        DnsAnswerTranslation *[]DnsRpDnsAnswerTranslationResourceModel `tfsdk:"dns_answer_translation" json:"dns_answer_translation,optional,omitempty" `
        DomainSpecificDnsServer *[]DomainSpecificDnsServerResourceModel `tfsdk:"domain_specific_dns_server" json:"domain_specific_dns_server,optional,omitempty" `
        Etag types.String `tfsdk:"etag" json:"etag,optional,omitempty" fpro:"etag"`
        FixedDomainAnswer *[]DnsRpFixedDomainAnswerResourceModel `tfsdk:"fixed_domain_answer" json:"fixed_domain_answer,optional,omitempty" `
        HostnameMapping *[]DnsRpHostnameMappingResourceModel `tfsdk:"hostname_mapping" json:"hostname_mapping,optional,omitempty" `
...
func (r *DnsRelayProfileResourceModel) GetSliceIds(ctx context.Context) []string {
