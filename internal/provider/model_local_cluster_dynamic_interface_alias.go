...
type LocalClusterDynamicInterfaceAliasResourceModel struct {
...
func (r *LocalClusterDynamicInterfaceAliasResourceModel) GetSliceIds(ctx context.Context) []string {
