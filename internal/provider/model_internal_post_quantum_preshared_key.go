...
type InternalPostQuantumPresharedKeyResourceModel struct {
	...
	PrimaryPpkId       types.String                                       `tfsdk:"primary_ppk_id" json:"primary_ppk_id,optional,omitempty" `
	PrimaryPpkSecret   types.String                                       `tfsdk:"primary_ppk_secret" json:"primary_ppk_secret,optional,omitempty" `
	ReadOnly           types.Bool                                         `tfsdk:"read_only" json:"read_only,optional,omitempty" fpro:"read_only"`
	SecondaryPpkId     types.String                                       `tfsdk:"secondary_ppk_id" json:"secondary_ppk_id,optional,omitempty" `
	SecondaryPpkSecret types.String                                       `tfsdk:"secondary_ppk_secret" json:"secondary_ppk_secret,optional,omitempty" `
...
func (r *InternalPostQuantumPresharedKeyResourceModel) GetSliceIds(ctx context.Context) []string {
