...
type AccessControlListResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        GrantedElement *[]types.String `tfsdk:"granted_element" json:"granted_element,optional,omitempty" `
...
func (r *AccessControlListResourceModel) GetSliceIds(ctx context.Context) []string {
