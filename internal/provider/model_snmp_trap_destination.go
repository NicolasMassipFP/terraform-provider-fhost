...
// This file was automatically generated from OpenAPI schema: SNMP_Trap_Destination
...
type SnmpTrapDestinationResourceModel struct {
	...
	DestinationPort types.Int64                                        `tfsdk:"destination_port" json:"destination_port,optional,omitempty" `
...
func (r *SnmpTrapDestinationResourceModel) GetSliceIds(ctx context.Context) []string {
