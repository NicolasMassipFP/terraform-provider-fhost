...
type LogicalInterfaceResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        OneLan types.Bool `tfsdk:"one_lan" json:"one_lan,optional,omitempty" `
...
func (r *LogicalInterfaceResourceModel) GetSliceIds(ctx context.Context) []string {
