...
type VirtualPhysicalInterfaceResourceModel struct {
	...
	VlanInterfaces                *[]VirtualVlanPhysicalInterfaceResourceModel       `tfsdk:"vlan_interfaces" json:"vlanInterfaces,optional,omitempty" `
	ZoneRef                       types.String                                       `tfsdk:"zone_ref" json:"zone_ref,optional,omitempty" `
}

func (r *VirtualPhysicalInterfaceResourceModel) GetSliceIds(ctx context.Context) []string {
