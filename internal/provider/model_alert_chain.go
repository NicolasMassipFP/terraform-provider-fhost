...
type AlertChainResourceModel struct {
	ID            types.String                                       `tfsdk:"id"`
	AdminDomain   types.String                                       `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
	AlertChainRef types.String                                       `tfsdk:"alert_chain_ref" json:"alert_chain_ref,optional,omitempty" `
...
func (r *AlertChainResourceModel) GetSliceIds(ctx context.Context) []string {
