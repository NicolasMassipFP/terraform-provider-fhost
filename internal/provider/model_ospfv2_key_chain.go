...
type Ospfv2KeyChainResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        Ospfv2KeyChainEntry *[]OspfKeyChainEntryResourceModel `tfsdk:"ospfv2_key_chain_entry" json:"ospfv2_key_chain_entry,optional,omitempty" `
...
func (r *Ospfv2KeyChainResourceModel) GetSliceIds(ctx context.Context) []string {
