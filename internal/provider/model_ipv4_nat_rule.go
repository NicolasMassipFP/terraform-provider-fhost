...
type Ipv4NatRuleResourceModel struct {
	...
	UsedOn            *UsedOnEngineResourceModel                         `tfsdk:"used_on" json:"used_on,optional,omitempty" `
}

func (r *Ipv4NatRuleResourceModel) GetSliceIds(ctx context.Context) []string {
