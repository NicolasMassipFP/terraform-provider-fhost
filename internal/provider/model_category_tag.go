...
type CategoryTagResourceModel struct {
	ID                types.String                                       `tfsdk:"id"`
	AdminDomain       types.String                                       `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
	CategoryParentRef *[]types.String                                    `tfsdk:"category_parent_ref" json:"category_parent_ref,optional,omitempty" `
...
func (r *CategoryTagResourceModel) GetSliceIds(ctx context.Context) []string {
