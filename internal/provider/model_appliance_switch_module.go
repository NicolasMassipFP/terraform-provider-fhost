...
type ApplianceSwitchModuleResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        ConfValue types.String `tfsdk:"conf_value" json:"conf_value,optional,omitempty" `
        ...
        PortCount types.Int64 `tfsdk:"port_count" json:"port_count,optional,omitempty" `
...
func (r *ApplianceSwitchModuleResourceModel) GetSliceIds(ctx context.Context) []string {
