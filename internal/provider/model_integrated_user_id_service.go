...
type IntegratedUserIdServiceResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        IuisDomain types.String `tfsdk:"iuis_domain" json:"iuis_domain,optional,omitempty" `
        IuisIgnore *[]IntegratedUisIgnoreValueResourceModel `tfsdk:"iuis_ignore" json:"iuis_ignore,optional,omitempty" `
        IuisInitialQueryTime types.Int64 `tfsdk:"iuis_initial_query_time" json:"iuis_initial_query_time,optional,omitempty" `
        IuisPollingInterval types.Int64 `tfsdk:"iuis_polling_interval" json:"iuis_polling_interval,optional,omitempty" `
...
func (r *IntegratedUserIdServiceResourceModel) GetSliceIds(ctx context.Context) []string {
