...
type ProxyServerResourceModel struct {
	
	ID                    types.String `tfsdk:"id"`
    AddXForwardedFor types.Bool `tfsdk:"add_x_forwarded_for" json:"add_x_forwarded_for,optional,omitempty" `
        ...
        BalancingMode types.String `tfsdk:"balancing_mode" json:"balancing_mode,optional,omitempty" `
        ...
        FpProxyKey types.String `tfsdk:"fp_proxy_key" json:"fp_proxy_key,optional,omitempty" `
        FpProxyKeyHashed types.String `tfsdk:"fp_proxy_key_hashed" json:"fp_proxy_key_hashed,optional,omitempty" `
        FpProxyKeyId types.Int64 `tfsdk:"fp_proxy_key_id" json:"fp_proxy_key_id,optional,omitempty" `
        FpProxyUserId types.String `tfsdk:"fp_proxy_user_id" json:"fp_proxy_user_id,optional,omitempty" `
        HttpProxy types.String `tfsdk:"http_proxy" json:"http_proxy,optional,omitempty" `
        InspectedService *[]InspectedServiceResourceModel `tfsdk:"inspected_service" json:"inspected_service,optional,omitempty" `
        ...
        TrustHostHeader types.Bool `tfsdk:"trust_host_header" json:"trust_host_header,optional,omitempty" `
        
}
func (r *ProxyServerResourceModel) GetSliceIds(ctx context.Context) []string {
