...
type SshHostKeyResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        KeyFingerprint types.String `tfsdk:"key_fingerprint" json:"key_fingerprint,optional,omitempty" `
        KeyLength types.Int64 `tfsdk:"key_length" json:"key_length,optional,omitempty" `
        KeyServiceRef *[]types.String `tfsdk:"key_service_ref" json:"key_service_ref,optional,omitempty" `
        KeyType types.String `tfsdk:"key_type" json:"key_type,optional,omitempty" `
...
func (r *SshHostKeyResourceModel) GetSliceIds(ctx context.Context) []string {
