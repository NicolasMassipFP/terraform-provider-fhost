...
type BgpConnectionProfileResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        Connect types.Int64 `tfsdk:"connect" json:"connect,optional,omitempty" `
        ...
        SessionHoldTimer types.Int64 `tfsdk:"session_hold_timer" json:"session_hold_timer,optional,omitempty" `
        SessionKeepAlive types.Int64 `tfsdk:"session_keep_alive" json:"session_keep_alive,optional,omitempty" `
...
func (r *BgpConnectionProfileResourceModel) GetSliceIds(ctx context.Context) []string {
