...
type UpgradeNodeTaskResourceModel struct {
	
	ID                    types.String `tfsdk:"id"`
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        Command types.String `tfsdk:"command" json:"command,optional,omitempty" `
        Comment types.String `tfsdk:"comment" json:"comment,optional,omitempty" `
        EngineUpgradeFilename types.String `tfsdk:"engine_upgrade_filename" json:"engine_upgrade_filename,optional,omitempty" `
...
func (r *UpgradeNodeTaskResourceModel) GetSliceIds(ctx context.Context) []string {
