...
type DhcpEnabledInterfaceAddressesAliasResourceModel struct {
...
func (r *DhcpEnabledInterfaceAddressesAliasResourceModel) GetSliceIds(ctx context.Context) []string {
