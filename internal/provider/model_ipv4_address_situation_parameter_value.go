...
type Ipv4AddressSituationParameterValueResourceModel struct {
...
func (r *Ipv4AddressSituationParameterValueResourceModel) GetSliceIds(ctx context.Context) []string {
