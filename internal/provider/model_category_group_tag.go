...
type CategoryGroupTagResourceModel struct {
	ID               types.String                                       `tfsdk:"id"`
	AdminDomain      types.String                                       `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
	CategoryChildRef *[]types.String                                    `tfsdk:"category_child_ref" json:"category_child_ref,optional,omitempty" `
...
func (r *CategoryGroupTagResourceModel) GetSliceIds(ctx context.Context) []string {
