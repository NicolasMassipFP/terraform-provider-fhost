...
type IpServiceResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        ProtocolNumber types.Int64 `tfsdk:"protocol_number" json:"protocol_number,optional,omitempty" `
...
func (r *IpServiceResourceModel) GetSliceIds(ctx context.Context) []string {
