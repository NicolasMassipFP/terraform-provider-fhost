...
type InternalEndpointResourceModel struct {
    ...
    Address types.String `tfsdk:"address" json:"address,optional,omitempty" `
        ...
        PhysicalInterface types.String `tfsdk:"physical_interface" json:"physical_interface,optional,omitempty" `
...
func (r *InternalEndpointResourceModel) GetSliceIds(ctx context.Context) []string {
