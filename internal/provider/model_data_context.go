...
type DataContextResourceModel struct {
	...
	InfoDataTag types.Int64                                        `tfsdk:"info_data_tag" json:"info_data_tag,optional,omitempty" `
...
func (r *DataContextResourceModel) GetSliceIds(ctx context.Context) []string {
