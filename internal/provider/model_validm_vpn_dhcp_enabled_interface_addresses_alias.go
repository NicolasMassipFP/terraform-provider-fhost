...
type ValidmVpnDhcpEnabledInterfaceAddressesAliasResourceModel struct {
...
func (r *ValidmVpnDhcpEnabledInterfaceAddressesAliasResourceModel) GetSliceIds(ctx context.Context) []string {
