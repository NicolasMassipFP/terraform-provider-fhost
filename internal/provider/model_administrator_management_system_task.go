...
type AdministratorManagementSystemTaskResourceModel struct {
...
func (r *AdministratorManagementSystemTaskResourceModel) GetSliceIds(ctx context.Context) []string {
