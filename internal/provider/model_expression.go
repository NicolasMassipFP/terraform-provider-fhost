...
type ExpressionResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        SubExpression *[]ExpressionResourceModel `tfsdk:"sub_expression" json:"sub_expression,optional,omitempty" `
...
func (r *ExpressionResourceModel) GetSliceIds(ctx context.Context) []string {
