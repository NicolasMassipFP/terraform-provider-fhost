...
type ExternalBgpPeerResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        NeighborAs types.String `tfsdk:"neighbor_as" json:"neighbor_as,optional,omitempty" `
        NeighborIp types.String `tfsdk:"neighbor_ip" json:"neighbor_ip,optional,omitempty" `
        NeighborPort types.Int64 `tfsdk:"neighbor_port" json:"neighbor_port,optional,omitempty" `
...
func (r *ExternalBgpPeerResourceModel) GetSliceIds(ctx context.Context) []string {
