...
type WebAccessServerResourceModel struct {
    ...
    Address types.String `tfsdk:"address" json:"address,optional,omitempty" `
        ...
        AlertServer types.String `tfsdk:"alert_server" json:"alert_server,optional,omitempty" `
...
func (r *WebAccessServerResourceModel) GetSliceIds(ctx context.Context) []string {
