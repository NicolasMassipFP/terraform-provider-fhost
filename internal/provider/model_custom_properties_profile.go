...
type CustomPropertiesProfileResourceModel struct {
	...
	CustomProperty *[]CustomPropertyResourceModel                     `tfsdk:"custom_property" json:"custom_property,optional,omitempty" `
...
func (r *CustomPropertiesProfileResourceModel) GetSliceIds(ctx context.Context) []string {
