...
type MatchExpressionResourceModel struct {
    ...
    AdminDomain types.String `tfsdk:"admin_domain" json:"admin_domain,optional,omitempty" fpro:"admin_domain"`
        ...
        ServicePortSelection types.String `tfsdk:"service_port_selection" json:"service_port_selection,optional,omitempty" `
...
func (r *MatchExpressionResourceModel) GetSliceIds(ctx context.Context) []string {
