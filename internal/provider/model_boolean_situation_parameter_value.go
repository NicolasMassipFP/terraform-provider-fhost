...
type BooleanSituationParameterValueResourceModel struct {
    ...
    Comment types.String `tfsdk:"comment" json:"comment,optional,omitempty" `
        ...
        Value types.Bool `tfsdk:"value" json:"value,optional,omitempty" `
        
}
func (r *BooleanSituationParameterValueResourceModel) GetSliceIds(ctx context.Context) []string {
