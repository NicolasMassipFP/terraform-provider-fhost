...
type CloudAutoScaledGroupResourceModel struct {
	...
	InstalledPolicy types.String                                       `tfsdk:"installed_policy" json:"installed_policy,optional,omitempty" `
	IsMonitored     types.Bool                                         `tfsdk:"is_monitored" json:"is_monitored,optional,omitempty" `
...
func (r *CloudAutoScaledGroupResourceModel) GetSliceIds(ctx context.Context) []string {
